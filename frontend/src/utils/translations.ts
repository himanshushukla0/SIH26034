...
export const translations: Record<Language, TranslationDictionary> = {
  en: {
    ...
    masthead_dept: "KRAYA-RAKSHAK (क्रय-रक्षक) • LMPC REGULATORY SYSTEM",
    masthead_title: "KRAYA-RAKSHAK: AUTOMATED COMPLIANCE ENGINE",
  ...
  hi: {
    ...
    masthead_dept: "क्रय-रक्षक (KRAYA-RAKSHAK) • विधिक मापविज्ञान अनुपालन प्रणाली",
    masthead_title: "क्रय-रक्षक: स्वचालित एलएमपीसी अनुपालन इंजन",
